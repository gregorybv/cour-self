  ...
  return (
    <CartItemWrapper className='grid'>
      ...
      <div className='cart-item-info'>
        ...
        <div
          className='cart-item-category bg-orange fs-12 d-inline-block text-capitalize text-white fw-7'>{cartItem.category}</div>
        <br/>
        <button type="button" className='remove-btn fs-13 text-dark fw-6'
                onClick={() => removeFromCart(cartItem.courseID)}>Remove <span><FaTrashAlt/></span></button>
      </div>
    </CartItemWrapper>
  )
});

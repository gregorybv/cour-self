...
const otherImages = {hero_img, logo_udemy};

const categoriesImages = [cat_python, cat_web_development, cat_data_science, cat_aws, cat_design, cat_marketing];

export { courseImages, otherImages, categoriesImages };